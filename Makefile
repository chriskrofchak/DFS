...
WATDFS_CLI_FILES= watdfs_client.cpp watdfs_make_args.cpp a2_client.cpp openbook.cpp upload.cpp rpc_lock.cpp
WATDFS_CLI_OBJS= watdfs_client.o watdfs_make_args.o a2_client.o openbook.o upload.o rpc_lock.o 
